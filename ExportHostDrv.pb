...
Procedure ListDriver(hFile = 0) 
  ...
  If NbDriver
    ...
    If hFile = 0
      PrintN("List of " + NbDriver + " Third-Party (OEM) Driver Packages :")
      PrintN("")
    EndIf
    ...
    EndWith
  Else
    PrintNError("No Third-Party (OEM) Driver Package Found")
  EndIf
...
Procedure CopyDriver() 
  ...
  If NbDriver
    ...
    If hFile
      ...
      WriteStringN(hFile, "")
      WriteStringN(hFile, "Export of " + NbDriver + " Third-Party (OEM) Driver Packages :")
      WriteStringN(hFile, "")
      ListDriver(hFile)
      CloseFile(hFile)
    EndIf 
    
    PrintN("Export of " + NbDriver + " Third-Party (OEM) Driver Packages :")
    PrintN("")
...
OpenConsole()
PrintN("")
PrintN("Export Host Third-Party (OEM) Driver Packages.")
PrintN("")
